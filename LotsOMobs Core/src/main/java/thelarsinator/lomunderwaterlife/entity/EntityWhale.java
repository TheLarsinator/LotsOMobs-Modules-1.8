...
public class EntityWhale extends EntityMob
{
    ...
    public EntityWhale(World worldIn)
    {
        ...
        this.tasks.addTask(2, entityaimovetowardsrestriction = new EntityAIMoveTowardsRestriction(this, 1.0D));
        this.tasks.addTask(3, this.wander = new EntityAIWander(this, 1.0D, 80));
        this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
        this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityWhale.class, 12.0F, 0.01F));
        ...
        this.moveHelper = new EntityWhale.GuardianMoveHelper();
        ...
        if (this.isElder())
        {
            ...
            if ((this.ticksExisted + this.getEntityId()) % 1200 == 0)
            {
                ...
                List list = this.worldObj.getPlayers(EntityPlayerMP.class, new Predicate()
                {
                    ...
                    {
                        return EntityWhale.this.getDistanceSqToEntity(p_179913_1_) < 2500.0D && p_179913_1_.theItemInWorldManager.func_180239_c();
                    }
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        {
            this.entityDropItem(new ItemStack(LotsOMobsItems.RawWhale, j/2), 1.0F);
        }
 ...
 /*   public boolean attackEntityFrom(DamageSource source, float amount)
    ...
    {
        private EntityWhale field_179930_g = EntityWhale.this;
        private static final String __OBFID = "CL_00002209";

        public GuardianMoveHelper()
        {
            super(EntityWhale.this);
        }
