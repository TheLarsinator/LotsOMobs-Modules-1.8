package thelarsinator.lomunderwaterlife.entity;
...
public class EntityBigFish extends EntityMob
{
    ...
    public EntityBigFish(World worldIn)
    {
        super(worldIn);
        ...
        this.setSize(1F, 1F);
        //this.tasks.addTask(4, new EntityWhale.AIGuardianAttack());
        EntityAIMoveTowardsRestriction entityaimovetowardsrestriction;
        this.tasks.addTask(0, entityaimovetowardsrestriction = new EntityAIMoveTowardsRestriction(this, 1.0D));
        this.tasks.addTask(0, this.wander = new EntityAIWander(this, 1.0D, 80));
        this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
        this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityBigFish.class, 12.0F, 0.01F));
        this.tasks.addTask(9, new EntityAILookIdle(this));
        this.wander.setMutexBits(3);
        entityaimovetowardsrestriction.setMutexBits(3);
        //this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, EntityLivingBase.class, 10, true, false, new EntityWhale.GuardianTargetSelector()));
        this.moveHelper = new EntityBigFish.GuardianMoveHelper();
        ...
        if (this.isElder())
        {
            ...
            if ((this.ticksExisted + this.getEntityId()) % 1200 == 0)
            {
                ...
                List list = this.worldObj.getPlayers(EntityPlayerMP.class, new Predicate()
                {
                    ...
                    {
                        return EntityBigFish.this.getDistanceSqToEntity(p_179913_1_) < 2500.0D && p_179913_1_.theItemInWorldManager.func_180239_c();
                    }
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        {
            this.entityDropItem(new ItemStack(Items.fish, j/2), 1.0F);
        }
 ...
 /*   public boolean attackEntityFrom(DamageSource source, float amount)
    ...
    {
        private EntityBigFish field_179930_g = EntityBigFish.this;
        private static final String __OBFID = "CL_00002209";

        public GuardianMoveHelper()
        {
            super(EntityBigFish.this);
        }
