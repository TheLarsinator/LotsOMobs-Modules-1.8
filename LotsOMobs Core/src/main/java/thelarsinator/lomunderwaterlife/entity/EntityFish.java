...
public class EntityFish extends EntityMob
{
    ...
    public EntityFish(World worldIn)
    {
        ...
        this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityFish.class, 12.0F, 0.01F));
        ...
        this.moveHelper = new EntityFish.GuardianMoveHelper();
        ...
        if (this.isElder())
        {
            ...
            if ((this.ticksExisted + this.getEntityId()) % 1200 == 0)
            {
                ...
                List list = this.worldObj.getPlayers(EntityPlayerMP.class, new Predicate()
                {
                    ...
                    {
                        return EntityFish.this.getDistanceSqToEntity(p_179913_1_) < 2500.0D && p_179913_1_.theItemInWorldManager.func_180239_c();
                    }
