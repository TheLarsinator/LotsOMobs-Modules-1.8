...
public class EntityFrog extends EntityLiving implements IMob
{
    ...
    {
        super(worldIn);
        this.moveHelper = new EntityFrog.SlimeMoveHelper();
    ...
    public void setDead()
    {
        ...
        if (!this.worldObj.isRemote && i > 1 && this.getHealth() <= 0.0F)
        {
            ...
            for (int k = 0; k < j; ++k)
            {
                ...
                EntityFrog entityslime = this.createInstance();
    ...
    {
        private EntityFrog field_179466_a = EntityFrog.this;
        ...
        public void updateTask()
        {
            ...
            ((EntityFrog.SlimeMoveHelper)this.field_179466_a.getMoveHelper()).func_179920_a(this.field_179466_a.rotationYaw, this.field_179466_a.canDamagePlayer());
        }
    }

    class AISlimeFaceRandom extends EntityAIBase
    {
        private EntityFrog field_179461_a = EntityFrog.this;
        ...
        public void updateTask()
        {
            ...
            ((EntityFrog.SlimeMoveHelper)this.field_179461_a.getMoveHelper()).func_179920_a(this.field_179459_b, false);
        }
    }

    class AISlimeFloat extends EntityAIBase
    {
        private EntityFrog field_179457_a = EntityFrog.this;
        private static final String __OBFID = "CL_00002201";

        public AISlimeFloat()
        {
            this.setMutexBits(5);
            ((PathNavigateGround)EntityFrog.this.getNavigator()).func_179693_d(true);
        }
        ...
        public void updateTask()
        {
            ...
            ((EntityFrog.SlimeMoveHelper)this.field_179457_a.getMoveHelper()).func_179921_a(1.2D);
        }
    }

    class AISlimeHop extends EntityAIBase
    {
        private EntityFrog field_179458_a = EntityFrog.this;
        ...
        public void updateTask()
        {
            ((EntityFrog.SlimeMoveHelper)this.field_179458_a.getMoveHelper()).func_179921_a(1.0D);
        }
    }
    ...
    class SlimeMoveHelper extends EntityMoveHelper
    {
        ...
        private EntityFrog field_179925_i = EntityFrog.this;
